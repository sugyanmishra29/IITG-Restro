...
public class itemEditor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageReference = FirebaseStorage.getInstance().getReference().child("Restaurents").child(cuser.getUid()).child("itemPictures");
        mReference = FirebaseDatabase.getInstance().getReference().child("Restaurents").child(cuser.getUid()).child("items");
